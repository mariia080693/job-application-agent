...
Your goal is to write a 1 page cover letter (under 300 words) based on given cover letter outline, the job description information, and the user's CV.
You need to write a 1 page cover letter that follows the outline and highlights the user's skills and experience that are relevant to the job.
